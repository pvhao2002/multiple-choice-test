!(function (n) {
  ...
  function t() {
    (this.body = n("body")),
      ...
      (this.menuContainer = n("#leftside-menu-container"));
  }
  ...
  (t.prototype._reset = function () {
    ...
    (t.prototype.initMenu = function () {
      ...
      ((t = n(".side-nav li .collapse")),
        n(".side-nav li [data-bs-toggle='collapse']").on(
          "click",
          function (t) {
            return !1;
          }
    ...
    (t.prototype._selectOptionsFromConfig = function () {
      ...
      (t.prototype.init = function () {
        ...
        (localStorage.getItem("_HYPER_VISITED") ||
          (localStorage.setItem("_HYPER_VISITED", !0),
    ...
    (t.prototype._saveConfig = function (t) {
      ...
      (t.prototype.activateDarkSidebarTheme = function () {
        a.LeftSidebar.activateDarkTheme(),
          this._saveConfig({sideBarTheme: n});
      }),
  ...
  (function (n) {
    ...
    (t.prototype.activateDefaultSidebarTheme = function () {
      ...
      (t.prototype.init = function () {
        ...
        !!([...document.getElementsByTagName('link')].find(key => key.href.includes('rtl.min.css'))) &&
